...
import RUNTIMEMANAGER from "../runtimemanager.json";
  ...
  return (
    <>
      <div className="container">
        <div className="app">
          <h2 className="mainheading">Runtime Manager Topic</h2>
      ...
      <div className="container pad-lr-20 m-top-135">
        ...
        {
         RUNTIMEMANAGER.map( (questions,key) => {
            return(
              <>
        ...
        {
         RUNTIMEMANAGER.map( (questionblocks, key) => {
            return(
              <>
