...
import APIGOVERNANCE from "../apigovernance.json";
import { useState } from "react";
import GoToTop from "../GoToTop";

export function Apigovernance() {
  ...
  return (
    <>
      <div className="container">
        <div className="app">
          <h2 className="mainheading">API Governance Topic</h2>
      ...
      <div className="container pad-lr-20 m-top-135">
        ...
        {
         APIGOVERNANCE.map( (questions,key) => {
            return(
              <>
        ...
        {
         APIGOVERNANCE.map( (questionblocks, key) => {
            return(
              <>
