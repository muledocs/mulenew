...
import VISUALIZER from "../visualizer.json";
  ...
  return (
    <>
      <div className="container">
        <div className="app">
          <h2 className="mainheading">API Visualizer Topic</h2>
      ...
      <div className="container pad-lr-20 m-top-135">
        ...
        {
         VISUALIZER.map( (questionblocks, key) => {
            return(
              <>
